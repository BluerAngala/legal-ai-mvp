...
export default function DocumentsPage() {
  ...
  const loadDocuments = useCallback(async () => {
    setLoading(true);
    try {
      const docs = await invoke<DocumentInfo[]>("list_dococuments" as any).catch(() => 
        invoke<DocumentInfo[]>("list_documents", { limit: 50, offset: 0 })
      );
      setDocuments(docs || []);
    } catch (e) {
          ...
          documents.map(doc => (
            ...
            >
              ...
              <div className="doc-meta">
                {doc.content_type} · {new Date(doc.created_at).toLocaleDateString("zh-CN")}
              </div>
        ...
        <div className="doc-viewer" onClick={() => setSelectedDoc(null)}>
          <div className="doc-viewer-content" onClick={e => e.stopPropagation()}>
            <div className="doc-viewer-header">
              ...
              <button className="doc-viewer-close" onClick={() => setSelectedDoc(null)}>×</button>
            </div>
